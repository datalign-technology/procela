    ...
    <div style={{ maxWidth: 820, margin: '0 auto' }}>
      ...
      <div style={sectionStyle}>
        ...
        <ul style={listStyle}>
          ...
          <li><strong>Inputs / Outputs panel — three kinds of link.</strong> Each row connects an activity to one of three things: a <strong>Data Asset</strong> (operational I/O), a <strong>Governance Document</strong> (charter, policy, standard the activity produces or consumes), or an <strong>Attachment</strong> (an uploaded file or URL bound to the activity). The <em>+ Add Input / Output</em> picker is segmented across the three kinds so you pick what kind first, then the specific target. A row's label is clickable: a data asset opens the asset detail, a document jumps to Governance Documents, an attachment downloads. So <em>Define Data Governance Charter</em> can finally link to the actual <em>Data Governance Charter</em> policy (CHA-001) as its Output, and upload the signed PDF as a separate output row.</li>
