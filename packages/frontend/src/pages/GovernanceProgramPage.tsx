...
function PhaseCard({
  ...
  return (
    <div style={{
      ...
      boxShadow: expanded ? `0 0 0 4px ${color}15` : isCurrent ? `0 0 0 4px ${color}15` : 'var(--shadow-sm)',
      ...
      <div
        ...
        style={{
          ...
          padding: 16, cursor: children ? 'pointer' : 'default',
          transition: 'background-color 0.12s',
        }}
        onMouseEnter={(e) => { if (children) e.currentTarget.style.backgroundColor = 'var(--color-bg)'; }}
