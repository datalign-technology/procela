...
// ---------------------------------------------------------------------------
// WebAuthn / FIDO2 + passwordless discoverable login
// ---------------------------------------------------------------------------
// Handlers live in ./auth-webauthn.ts. Mounted here so the paths
// stay /mfa/webauthn/... and /webauthn/discoverable/... under the
// same /api/v1/auth prefix as the rest of this router. The import
// is deferred via require() because auth-webauthn.ts imports shared
