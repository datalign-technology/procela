...
> **New here?** See [`docs/TRAINING.md`](../../docs/TRAINING.md) — a
> 90-minute click-by-click walkthrough that uses this data set to teach
...
| `agents.csv` | One agent of each type (AI, PIPELINE, BOT, SERVICE_ACCOUNT, OTHER) — enough to teach the concept without turning owner-assignment into a data-entry exercise. Extend from here when you're ready. | Assign to **Tidewater Utilities** (or a more specific org if you prefer). |
...
It exercises a different industry than the default Momentum Shipbuilding
